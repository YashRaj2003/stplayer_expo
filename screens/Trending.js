...
export default function Trending({ navigation }) {
    ...
    const Item = ({ title, thumbnail, label, id }) => (
        <View>
            <TouchableOpacity style={{ paddingBottom: 5, backgroundColor: "white", marginTop: 5 }} onPress={() => { reward(); navigation.push('Videoplayer', { id: id }); }}>
    ...
    return (
        <SafeAreaView >
            ...
            <View style={{ backgroundColor: "white", flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 10, paddingHorizontal: 7 }}>
            ...
            <FlatList
                ...
                ListFooterComponent={() => <View style={{ alignItems: "center", justifyContent: "center", marginTop: 8 }}>
                    <AdMobBanner
                        bannerSize="Banner"
                        adUnitID="ca-app-pub-2058503082715827/3172170629"
                        servePersonalizedAds
